...
function timeSince(date) {
  ...
  function AppController(scope){
    ...
    this.accessKey = null;
    this.secretKey = null;
    this.regionName = 'ap-northeast-1';
  ...
  AppController.prototype.createClient1 = function() {
    var options = {
      clientId : Math.random().toString(36).substr(2, 5),
      endpoint: 'a3ga5tu9j45csi.iot.ap-northeast-1.amazonaws.com',
      accessKey: 'AKIAJB6QQDIU63XTXSVQ',
      secretKey: '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',
  ...
  AppController.prototype.turnON = function(clientCtr){
      this.clients.turnon();
  };
  
  AppController.prototype.turnOFF = function(clientCtr){
      this.clients.turnoff();
  };
...
//        self.client.scope.vm.foo.bar = true;
    ...
    this.client.on('connected', function(){
      ...
      self.client.subscribe(self.topicShadowGetAccepted); 
...
//      self.logs.log('subscribeSucess');
      self.client.publish(self.topicShadowGet,'');
    });
  ...
  MQTTClient.prototype.subscribe = function(topic) {
    ...
    try{
      this.client.subscribe(topic, {
        onSuccess: function(){
//            if(self.topic === ClientController.topicName){
//                return;
//            }
